...
export default function Hero() {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-24 pb-16 md:pt-32 md:pb-20">
      {/* Animated Background */}
      ...
      {/* Glassmorphism Card */}
      <div className="container mx-auto px-6 sm:px-8 lg:px-12 text-center relative z-10 flex items-center justify-center w-full">
        <motion.div
          initial={{ opacity: 0, y: 50 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
          className="backdrop-blur-xl bg-white/10 dark:bg-black/20 rounded-3xl p-8 sm:p-12 md:p-16 lg:p-20 shadow-2xl border border-white/20 mx-auto max-w-5xl w-full"
        >
          <motion.h1 
