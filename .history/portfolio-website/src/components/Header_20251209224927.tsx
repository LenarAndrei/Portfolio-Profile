...
export default function Header() {
  ...
  return (
    <>
      ...
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[60] focus:px-6 focus:py-3 focus:bg-blue-600 focus:text-white focus:rounded-xl focus:font-semibold focus:shadow-lg"
      >
      ...
      <div className="container mx-auto px-6 lg:px-8">
        ...
        <AnimatePresence>
          {isMenuOpen && (
            ...
            >
              <nav id="mobile-menu" className="py-4 space-y-2 bg-gray-50/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl mt-4 border border-gray-200/50 dark:border-gray-700/50 shadow-xl" aria-label="Mobile navigation">
