...
export default function Hero() {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden py-20">
      ...
      {/* Glassmorphism Card */}
      <div className="container mx-auto px-8 lg:px-16 xl:px-20 text-center relative z-10 flex items-center justify-center min-h-screen">
        <motion.div
          initial={{ opacity: 0, y: 50 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
          className="backdrop-blur-xl bg-white/10 dark:bg-black/20 rounded-3xl p-16 lg:p-20 xl:p-24 shadow-2xl border border-white/20 mx-auto max-w-6xl w-full"
        >
          <motion.h1 
