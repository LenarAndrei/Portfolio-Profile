...
export default function About() {
  ...
  return (
    <section id="about" className="py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-8 lg:px-16 xl:px-20 relative z-10 max-w-7xl">
        <motion.div
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
          viewport={{ once: true }}
          className="text-center mb-24 lg:mb-32 flex flex-col items-center justify-center"
        >
          <motion.div 
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-20 lg:gap-24 xl:gap-28 items-center justify-center mb-28 lg:mb-36">
            <motion.div
